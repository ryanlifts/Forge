...
check("native service-worker cache is bumped", sw.includes('const CACHE = "blackpyre-v111"'));
...
check(
  ...
  && dSimpleRemove9011.querySelector(
       '[data-exercise-removal-undo="Run"]'
     ).closest(".removed-exercise-card")
     .textContent.includes("Exercise removed from today")
);
