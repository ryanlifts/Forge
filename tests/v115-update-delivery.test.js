...
check(
  ...
  /register\("sw\.js\?v=web-v116-runtime-integrity-1",\{updateViaCache:"none"\}\)/.test(boot)
);
...
check(
  ...
  /blackpyre-v116-runtime-integrity-1/.test(sw)
  &&/scripts\/07-boot\.js\?v=web-v116-runtime-integrity-1/.test(index)
);
