...
check(
  ...
  /register\("sw\.js\?v=web-v115-update-delivery-1",\{updateViaCache:"none"\}\)/.test(boot)
);
...
check(
  ...
  /blackpyre-v115-update-delivery-1/.test(sw)
  &&/scripts\/07-boot\.js\?v=web-v115-update-delivery-1/.test(index)
);
