...
check(
  ...
  /register\("sw\.js\?v=web-v118-unified-removal-1",\{updateViaCache:"none"\}\)/.test(boot)
);
...
check(
  ...
  /blackpyre-v118-unified-removal-1/.test(sw)
  &&/scripts\/07-boot\.js\?v=web-v118-unified-removal-1/.test(index)
);
