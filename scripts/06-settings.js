...
function renderSetupStep(){
  ...
  if(setupStep===1){
    ...
    body.innerHTML='<div class="card"><div class="label">Step 2 · Calorie calculator</div><div class="row" style="margin:10px 0 10px;">'
      ...
      +'<div class="note hidden" id="suCalcError" role="alert" aria-live="assertive" style="color:var(--warn);"></div><div id="suCalcPreview" role="status" aria-live="polite" style="font-size:13px;line-height:1.8;margin-top:8px;"></div><div class="note">Supports ages 13–100. Ages 13–17 use youth energy equations and a 20/55/25 Recommended starting split with every goal and schedule control available. Under 13 and pregnancy or breastfeeding are outside this calculator’s designed scope. Results are estimates, not medical advice. BlackPyre will not save or suggest a target below 1,200 kcal/day, and that floor does not mean it is appropriate for you.</div></div>';
