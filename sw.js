...
const SHELL = [
  ...
  "./scripts/01-storage.js?v=web-v113-recovery-history-1",
  "./scripts/02-food.js",
  "./scripts/03-card-profiles.js",
  "./scripts/03-train.js?v=web-v113-recovery-history-1",
  "./scripts/04-weight.js",
  "./scripts/05-ai.js?v=web-v113-recovery-history-1",
  "./scripts/06-settings.js?v=web-v113-recovery-history-1",
  "./scripts/07-boot.js?v=web-v113-recovery-history-1",
