...
const CACHE = "blackpyre-v122-assisted-pr-1";
const FOOD_CATALOG_CACHE = "blackpyre-food-catalog-v1";
const SHELL = [
  "./?app=web-v122-assisted-pr-1",
  "./index.html",
  "./data-quotes.js?v=web-v122-assisted-pr-1",
  "./data-foods.js?v=web-v122-assisted-pr-1",
  "./data-suggestions.js?v=web-v122-assisted-pr-1",
  "./data-food-catalog.js?v=web-v122-assisted-pr-1",
  "./data-faq.js?v=web-v122-assisted-pr-1",
  "./data-exercises.js?v=web-v122-assisted-pr-1",
  "./data-exercise-card-profiles.js?v=web-v122-assisted-pr-1",
  "./scripts/01-storage.js?v=web-v122-assisted-pr-1",
  "./scripts/02-food.js?v=web-v122-assisted-pr-1",
  "./scripts/03-card-profiles.js?v=web-v122-assisted-pr-1",
  "./scripts/03-train.js?v=web-v122-assisted-pr-1",
  "./scripts/04-weight.js?v=web-v122-assisted-pr-1",
  "./scripts/05-ai.js?v=web-v122-assisted-pr-1",
  "./scripts/06-settings.js?v=web-v122-assisted-pr-1",
  "./scripts/07-boot.js?v=web-v122-assisted-pr-1",
  "./vendor/html5-qrcode.min.js?v=web-v122-assisted-pr-1",
  "./manifest.json?v=web-v122-assisted-pr-1",
  "./icon-192.png",
  "./icon-512.png",
