...
const FAQ = [
  ...
  {q:"How do I log a workout?", a:"Open <b>Train</b>, choose the session, and record what actually happened. Enter the normal exercise values and tap <b>Save Exercise</b>; there is no separate Done button. If the plan says 8 reps and you complete 5, enter 5 — BlackPyre records what you actually did without calling the set missed or failed. Zero is not a special command. If you did not perform a set, tap <b>Remove</b>; the set is taken out of today’s workout and <b>Undo</b> is available. Use <b>+ Add set</b> for extra work. To stop an exercise for this workout, tap <b>Remove exercise</b>. The <b>•••</b> button holds secondary tools such as last workout values, video, and replacement. Tapping anywhere outside that menu closes it. Before <b>Log session</b>, every programmed set and exercise still has to be resolved. Removing work applies only to this workout and does not change the training program."},
  ...
  {q:"How does Apple Health work with BlackPyre?", a:"Apple Health is optional. Open <b>Settings → Apple Health</b> to connect it. You choose whether BlackPyre can read weight, active energy, steps, sleep, resting heart rate, HRV, workouts, and workout heart rate. Eligible completed workouts can be shared back only if you separately allow write access. Each permission works independently, so refusing one signal never blocks the others or BlackPyre's manual tracking. BlackPyre keeps only daily totals or latest values and workout heart-rate averages and maxima in a device-only cache. Health data is never included in BlackPyre backups, recovery files, or iOS/iCloud device backup. Active energy is shown separately and never changes your logged-trend TDEE or targets."},

  {q:"Why is Apple Health showing only some data?", a:"BlackPyre can read only signals that already exist in Apple Health and that you allowed it to access. An iPhone can record data such as steps, while sleep, heart rate, HRV, active energy, or body weight may require an Apple Watch, compatible scale, or another app to write that signal first. Check the Health app to confirm the value exists. To change access, open the Health app → your profile picture → Privacy → Apps → BlackPyre, then return to BlackPyre and tap <b>Sync Apple Health</b>. Missing or revoked Health access never deletes your BlackPyre history, and manual entry remains available."},


  {sec:"Your data & recovery"},

  {q:"Where is my data stored? Is it private?", a:"Your settings, logs, program, saved foods, and recovery data are stored on this device. BlackPyre has no user account, advertising, analytics SDK, or BlackPyre server that can read your personal log. Online packaged-food searches send only the search words or barcode to <b>Open Food Facts</b>; that service also receives ordinary network information such as your IP address. BlackPyre never transmits your logs, prompts, reports, or photos to an AI service; you control any copy, paste, or share handoff. Open <b>Settings → Privacy &amp; support</b> for the full policy."},

  {q:"How do I back up or move BlackPyre to another device?", a:"Open <b>Settings → Data &amp; recovery</b>. <b>Save backup</b> quickly saves a verified file inside <b>Files → On My iPhone → BlackPyre</b>. That folder and its backups are deleted if BlackPyre is uninstalled. <b>Save backup elsewhere</b> lets you keep a second copy in iCloud Drive, another folder, AirDrop, or another app. On another device, install BlackPyre and restore that backup."},

  {q:"How do I erase everything from BlackPyre?", a:"Open <b>Settings → Data &amp; recovery → Erase all BlackPyre data</b>. BlackPyre asks twice before permanently removing settings, logs, saved foods, programs, workout drafts, recovery snapshots, Native Vault files, and backups kept inside the app. Copies you saved somewhere else are not affected and must be deleted from those locations separately. Protected mode blocks destructive reset until recovery is resolved."},

  {q:"What is Protected mode, and what if my data disappears?", a:"If BlackPyre cannot safely read established saved data, it pauses normal saving instead of replacing it with empty information. <b>Do not uninstall the app or clear its data.</b> Open recovery and choose a validated recovery snapshot or one of your own backups. BlackPyre preserves the original saved information while recovery is being handled."},
