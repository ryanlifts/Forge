...
const FAQ = [
  ...
  {q:"How do I scan food?", a:"Use <b>Scan barcode</b> for a packaged food, or type the barcode and tap <b>Look up</b>. BlackPyre checks <b>My Foods</b> first. If an online result is found, compare it with the package. Tap <b>✓ Looks correct</b> to save that barcode to My Foods for future scans, or tap <b>Correct barcode data</b> to fix it. Looks correct saves the food but does not log the meal. <b>Nothing is logged until you review it and tap Add to log.</b>"},
