...
const FAQ = [
  ...
  {q:"How do I scan food?", a:"Use <b>Scan barcode</b> for a packaged food. BlackPyre checks foods you have already saved before using an online food database. Fresh online results should be compared with the package. If a barcode is not found, enter the label manually and save it if you want to reuse it. <b>Nothing is logged until you review it and tap Add to log.</b>"},
